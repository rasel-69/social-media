                ...
                <div className="rounded-3xl border border-zinc-800 bg-zinc-950/50 p-8 shadow-2xl backdrop-blur-xl">
                    ...
                    <div className="mt-6">
                        ...
                        <button
                            ...
                            className="mt-4 flex w-full items-center justify-center gap-3 rounded-xl border border-zinc-800 bg-zinc-900/50 py-3 text-sm font-medium transition hover:bg-zinc-900"
                        >
